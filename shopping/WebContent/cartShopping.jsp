<%@ page language="java" contentType="text/html; charset=UTF-8"  import="com.shopping.javabean.*,com.shopping.dao.*,java.sql.*,java.util.*"
    pageEncoding="UTF-8"%>
...
<p>名称<%=temp.getName() %></p>
<p>价格<%=temp.getPrice() %></p>
<%--在div2后面加一个商品的编号可以区别是那个商品 --%>
数量<div id = "div2<%=rm.getiId() %>" class = "div2"><%=rm.getNum() %></div>
<%-- 
