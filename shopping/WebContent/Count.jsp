<%@ page language="java" contentType="text/html; charset=UTF-8" import= "com.shopping.dao.*,com.shopping.javabean.*,java.util.*"
    pageEncoding="UTF-8"%>
...
<div class = "topDiv">
	...
	<div id = "top_name"><font size = "4px" color ="red"><%=uId %></font></div>
...
<td width="300px"><font size = "4px">￥<%=allCount %></font></td>
</tr>
