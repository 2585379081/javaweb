...
<title>图书修改</title>
<link rel="stylesheet" type="text/css" href="<%=basePath %>css/BookUpdate.css">

<script src = "<%=basePath %>js/jQuery.js" ></script>
<script src = "<%=basePath %>js/BookUpdate.js" ></script>
...
<tr>
<td>图书起始序号</td>
<td><input type ="text" id ="bkID"/>&nbsp;&nbsp;&nbsp;&nbsp;<input type = "button" value = "查询" onclick = "find()"/></td>
</tr>
<tr>
<td>索书号</td>
...
封面：<br/>
	...
	<div id = "right_image">
		<img  width ="350px" id = "bkCover" height ="310px"/>
	</div>
	<br/>
