...
function queryReaderInfo(){
	...
	window.location.href = "http://localhost:8080/Libarary/servlet/BorrowReaderInfo?rdID="+rdID;
...
function bookQuery(){
	...
	window.location.href = "http://localhost:8080/Libarary/servlet/BorrowReaderInfo?bkID="+bkID+"&bkName="+bkName;
